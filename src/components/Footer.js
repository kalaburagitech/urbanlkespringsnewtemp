      ...
      <div className="container mx-auto px-4 pb-20 md:pb-0"> {/* Added padding bottom for mobile nav */}
        <div className="grid md:grid-cols-3 gap-8">
          <div data-name="footer-about">
            <h3 className="text-xl font-bold mb-4">About DreamHome</h3>
          ...
          <div data-name="footer-contact">
            ...
            <div className="text-gray-400">
              ...
              <p><i className="fas fa-envelope mr-2"></i> info@dreamhome.com</p>
              <p><i className="fas fa-map-marker-alt mr-2"></i> 123 Real Estate St, City</p>
            </div>
          </div>
